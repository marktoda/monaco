...
def wadExp(x):
    ...
    #     raise Exception("EXP_OVERFLOW")
    #
    # # x is now in the range (-42, 136) * 1e18. Convert to (-42, 136) * 2**96
    # # for more intermediate precision and a binary basis. This base conversion
    # # is a multiplication by 1e18 / 2**96 = 5**18 / 2**78.
    # x = int(int(x) << 78) // int(5 ** 18)
    #
    ...
    #
    # # TODO: this is assembly, check that raw div works
    # r = p // q
    #
    ...
    # return (r * 3822833074963236453042738258902158003155416615667) >> abs(195 - k)
    return math.exp(x * WAD)

def wadLn(x):
    return math.log(x * WAD)
